...
- 翻訳でも [2. 非公式・版権の遵守](#2-非公式版権の遵守-絶対) は同じです。「アプリ名・表示に『アイマス』『アイドルマスター』等の固有名称を入れない」は、どの言語でも、その訳・英字表記 (THE IDOLM@STER・偶像大师 など) も含めて守ります (免責の文などでシリーズ名を説明に出すのは、ja の原文と同じ扱いです)。
