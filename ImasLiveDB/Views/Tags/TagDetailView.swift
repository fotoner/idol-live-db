        ...
        List {
            if isLoading {
                ...
                if !detail.songs.isEmpty {
                    ...
                    Section(L10n.Tags.detailSongsHeader(name: detail.tag.name, count: detail.songs.count)) {
                    ...
                    Section {
                        ImasEmptyState(systemImage: "tag", title: String(localized: L10n.Tags.detailSongsEmpty))
                            .listRowBackground(DS.surface)
                            .listRowSeparatorTint(DS.sep)
                    }
                }
