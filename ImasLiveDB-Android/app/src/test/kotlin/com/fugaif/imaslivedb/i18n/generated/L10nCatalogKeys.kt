...
object L10nCatalogKeys {
    ...
    private fun search0(): List<L10nCatalogSample> = listOf(
        L10nCatalogSample("search.cross_tab.chip", "search_cross_tab_chip", listOf("ja", "ko"), "tab=かな カナ1, count=2026", { L10n.Search.crossTabChip(tab = "かな カナ1", count = 2026) }, mapOf("ja" to "かな カナ1に 2026", "ko" to "かな カナ1에 2026")),
